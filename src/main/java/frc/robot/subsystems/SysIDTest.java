...
//                         driveMotors[i].get() * RobotController.getBatteryVoltage(), Volts))
//                         .linearPosition(m_distance.mut_replace(encoders[i].getPosition().getValueAsDouble(), Meters))
//                         .linearVelocity(m_velocity.mut_replace(encoders[i].getVelocity().getValueAsDouble() , MetersPerSecond));
